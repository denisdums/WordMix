...
import {BasePostPageFragmentFragment, FrontPageQueryDocument, SettingsFragmentFragment} from "~/graphql/build/graphql";
...
export const loader: LoaderFunction = async ({context}): Promise<{
    settings: SettingsFragmentFragment | null | undefined,
    page: BasePostPageFragmentFragment | null | undefined
}> => {
